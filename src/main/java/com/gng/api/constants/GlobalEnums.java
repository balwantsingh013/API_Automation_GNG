...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_12__Positive__Username_Inactive("Verify that in the ValidateUsername endpoint request if the provided 'username' does exist in MariaDb and is 'Inactive', the endpoint response will return success = true, ErrorCode = 0, and usernameStatus = 'INACTIVE' "),
