...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_115__Positive__Valid_Street_Address___Maximum_parameters_or_No_Existing_Address____("Verify that if a well formed request with the maximum required parameters for a Street-type address is provided in the UpdateMailingAddress endpoint request where no address exists, the endpoint response will return success = true, errorCode = 0, errorMessage = '', and a new row is added to the Banner table UCRADDR with all of the data from the fields provided in request, the current date is set in UCRADDR_FROM_DATE, no value is set for UCRADDR_TO_DATE and UCRADDR_STATUS_IND is set to 'A'"),
        TC_116__Positive__Valid_Street_Address___Mixed_parameters_or_No_Existing_Address____("Verify that if a well formed request with a mix of valid parameters, including the minimum required parameters, for a Street-type address is provided in the UpdateMailingAddress endpoint request where NO ADDRESS exists, the endpoint response will return success = true, errorCode = 0, errorMessage = '', and a new row is added to the Banner table UCRADDR with all of the data from the fields provided in request, the current date is set in UCRADDR_FROM_DATE, no value is set for UCRADDR_TO_DATE and UCRADDR_STATUS_IND is set to 'A'"),
