...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_20__Negative__Invalid_Username__Not_Found("Verify that if the provided 'username' parameter does not exist and is used in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10357, ErrorMessage = 'Username Not Found'"),
        TC_21__Negative__Invalid_Username__Inactive("Verify that if the provided 'username' parameter value is inactive and is used in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        TC_22__Negative__Missing_Password("Verify that if the provided 'password' parameter value is missing in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10113, ErrorMessage = 'Missing Password'"),
        ...
        TC_24__Negative__Invalid_Password_Format__Length___Too_Long____("Verify that if the provided 'password' parameter value length is longer than 64 characters in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10157, ErrorMessage = 'Invalid Password Length. The password must be between 8 and 64 characters.'"),
        TC_25__Negative__Invalid_Password__Reused_Password("Verify that if the provided 'password' parameter value matches the current password in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10359, ErrorMessage = 'Invalid Password'"),
        TC_26__Positive__Password__Updated("Verify that if valid 'username' and 'password' parameters are provided in the UpdatePassword endpoint request, the endpoint response will return success = true, ErrorCode = 0"),
        TC_27__Positive__LoginID_Saved("Verify that if a value is provided for the optional 'loginID' parameter in the UpdatePassword endpoint request and the rest of the request is well formed the endpoint response will return success = true, ErrorCode = 0, and loginID value is saved/stored in the database."),
