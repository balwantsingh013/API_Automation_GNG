...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_02__Negative__Invalid_Request_ID_Length("Verify that if the provided requestID parameter length is larger than 32 characters in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        ...
        TC_04__Negative__Missing_CustomerCode("Verify that if the customerCode value is missing in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10011, ErrorMessage = 'Missing Customer Code'"),
        TC_05__Negative__Invalid_CustomerCode_Length("Verify that if the customerCode length is larger than 9 numeric characters in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_06__Negative__Invalid_CustomerCode_Format("Verify that if the customerCode value is not a numeric string in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_07__Negative__Missing_PremisesCode("Verify that if the premisesCode value is missing in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10013, ErrorMessage = 'Missing Premises Code'"),
        TC_08__Negative__Invalid_PremisesCode_Length("Verify that if the premisesCode length is larger than 7 numeric characters in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_09__Negative__Invalid_PremisesCode_Format("Verify that if the premisesCode value is not a numeric string in the GetBankDraftInfo endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
