...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_123__Positive__Valid_PO_Box_Address("Verify that if the request is well formed with the appropriate/required data for a PO Box-type address is provided in the UpdateMailingAddress endpoint request, the endpoint response will return success = true, errorCode = 0, errorMessage = ''"),
        TC_124__Positive__Valid_Rural_Route_Address("Verify that if the request is well formed with the appropriate/required data for a Rural Route-type address is provided in the UpdateMailingAddress endpoint request, the endpoint response will return success = true, errorCode = 0, errorMessage = ''"),
        TC_125__Positive__LoginID_Saved("Verify that if a value is provided for the optional loginID parameter in the UpdateMailingAddress endpoint request and the rest of the request is well formed the endpoint response will return success = true, ErrorCode = 0, and loginID value is saved/stored in the GZRAPIL_LOGIN_ID field in the GZRAPIL table"),

        TC_126__Negative__Missing_Request_ID("Verify that if the requestID parameter is missing in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_127__Negative__Invalid_Request_ID_Length("Verify that if the provided requestID parameter length is larger than 32 characters in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_128__Negative__Duplicate_Request_ID("Verify that if the provided requestID parameter already exists within Transaction Manager while executing the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_129__Negative__Missing_customerCode("Verify that if the customerCode value is missing in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, errorCode = 10011, errorMessage = 'Missing Customer Code'"),
        TC_130__Negative__Invalid_customerCode_Length("Verify that if the customerCode length is larger than 9 numeric characters in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_131__Negative__Invalid_customerCode_Format("Verify that if the customerCode value is not a numeric string in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_132__Negative__Invalid_Account_Number("Verify that if the provided combination of customerCode and premisesCode in the GetAccountRewards endpoint request doesn't exist in the UCBCUST table in Banner, the endpoint response will return data = null, success = false, ErrorCode = 40015, ErrorMessage = 'Invalid Account Number'"),
        TC_133__Negative__Missing_premisesCode("Verify that if the premisesCode value is missing in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, errorCode = 10013, errorMessage = 'Missing Premises Code'"),
        TC_134__Negative__Invalid_premisesCode_Length("Verify that if the premisesCode length is larger than 7 numeric characters in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_135__Negative__Invalid_premisesCode_Format("Verify that if the premisesCode value is not a numeric string in the GetAccountRewards endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_136__Positive__Rewards_Response_Returned_with_Active_Rewards("Verify that if all required fields are set in the GetAccountRewards endpoint request, the endpoint response will return success = true, ErrorCode = 0 and a response will be populated with the details of the account’s rewards for an account with Active reward(s). The response should contain three reward sections: 1. The total number of Active rewards greater than 0. 2. The total number of Pending rewards equals 0. 3. An array of the active reward(s) that contains: rewardID, rewardName, rewardTypeCode, rewardTypeDescription, status, rewardEstablishedDate, rewardInitiatedDate, remainingOccurrences, totalOccurrences, restrictions, referenceCustomerCode, referencePremisesCode"),
        ...
        TC_188__Negative__Missing_Request_ID("Verify that if the requestID parameter is missing in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_189__Negative__Invalid_Request_ID_Length("Verify that if the provided requestID parameter length is larger than 32 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_190__Negative__Duplicate_Request_ID("Verify that if the provided requestID parameter already exists within Transaction Manager while executing the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_191__Negative__Invalid_customerCode_Length("Verify that if the customerCode length is larger than 9 numeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_192__Negative__Invalid_customerCode_Format("Verify that if the customerCode value is not a numeric string in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_193__Negative__Invalid_premisesCode_Length("Verify that if the premisesCode length is larger than 7 numeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_194__Negative__Invalid_premisesCode_Format("Verify that if the premisesCode value is not a numeric string in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_195__Negative__Invalid_Last_or_Business_Name_Length("Verify that if the customerLastNameBusiness length is larger than 60 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10119, ErrorMessage = 'Invalid Last or Business Name Format'"),
        TC_196__Negative__Invalid_First_Name_Length("Verify that if the customerFirstName length is larger than 15 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10121, ErrorMessage = 'Invalid First Name Format'"),
        TC_197__Negative__Invalid_Last_Four_SSN_Length_Too_Long("Verify that if the lastFourSocialSecurityNumber length is larger than 4 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10063, ErrorMessage = 'Invalid Last Four SSN Format'"),
        TC_198__Negative__Invalid_Last_Four_SSN_Length_Too_Short("Verify that if the lastFourSocialSecurityNumber length is smaller than 4 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10063, ErrorMessage = 'Invalid Last Four SSN Format'"),
        TC_199__Negative__Invalid_Federal_Tax_ID_Length_Too_Long("Verify that if the federalTaxID length is larger than 9 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10069, ErrorMessage = 'Invalid Federal Tax ID Format'"),
        TC_200__Negative__Invalid_Federal_Tax_ID_Length_Too_Short("Verify that if the federalTaxID length is smaller than 9 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10069, ErrorMessage = 'Invalid Federal Tax ID Format'"),
        TC_201__Negative__Invalid_Email_Address_Format("Verify that if the emailAddress format is not {identifier}@{domain name}.{domain extension} in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10065, ErrorMessage = 'Invalid Email Address Format'"),
        TC_202__Negative__Invalid_Phone_Number_Length_Too_Long("Verify that if the phoneNumber length is larger than 10 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10009, ErrorMessage = 'Invalid Phone Number Format'"),
        TC_203__Negative__Invalid_Phone_Number_Length_Too_Short("Verify that if the phoneNumber length is smaller than 10 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10009, ErrorMessage = 'Invalid Phone Number Format'"),
        TC_204__Negative__Invalid_Username_Format("Verify that if username contains non-alphanumeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10353, ErrorMessage = 'Invalid Username Format'"),
        TC_205__Negative__Inactive_Username("Verify that in the SearchAccounts request if the provided username does exist in MariaDb and is Inactive, the endpoint response will return data = null, success = false, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        ...
        TC_221__Negative__PhoneNumber_____Username("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search but an invalid combination of parameters is used (phoneNumber + username), the endpoint response will return data = null, success = false, ErrorCode = 10377, ErrorMessage = 'Insufficient Search Criteria'"),
        ...
        TC_230__Positive__Last4SSN_____PhoneNumber("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using lastFourSocialSecurityNumber + 1 additional identification (phoneNumber), the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results."),
        TC_231__Positive__Password_____Username("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using password + 1 additional identification (username), the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results."),
        TC_232__Positive__Password_____CustomerLastNameBusiness("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using password + 1 additional identification (customerLastNameBusiness), the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results."),
        ...
        TC_234__Positive__Password_____EmailAddress("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using password + 1 additional identification (emailAddress), the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results."),
        TC_235__Positive__Password_____PhoneNumber("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using password + 1 additional identification (phoneNumber), the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results."),
        ...
        TC_259__Positive__PremisesAddress_No_StreetName("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations where the Street Name is NOT set for the account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the expected premisesStreetName in the response is set to an empty string."),
        TC_260__Positive__PremisesAddress_StreetSuffix("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations where the Street Suffix is set for the account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the expected premisesStreetSuffix in the response is set to the expected value."),
