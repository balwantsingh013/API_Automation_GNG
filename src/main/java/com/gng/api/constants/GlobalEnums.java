...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_183__Positive__Account_Info_Returned___Restricted_Plans____("Verify that if all required parameters (requestID, customerCode, premisesCode) are set in the GetAccountInfo endpoint request, and the account provided has Restricted Price Plan(s) available to them, the endpoint response will return success = true, errorCode = 0, errorMessage = '' and the response payload parameters contain all of the available data for the test account used and for the Restricted Plan(s) returned in the pricePlans array parameter, the restrictedPlanIndicator parameter is set to 'Y' in the response"),
        ...
        TC_189__Negative__Missing_Request_ID("Verify that if the requestID parameter is missing in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_190__Negative__Invalid_Request_ID_Length("Verify that if the provided requestID parameter length is larger than 32 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_191__Negative__Duplicate_Request_ID("Verify that if the provided requestID parameter already exists within Transaction Manager while executing the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_192__Negative__Invalid_customerCode_Length("Verify that if the customerCode length is larger than 9 numeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_193__Negative__Invalid_customerCode_Format__Not_String("Verify that if the customerCode value is not a numeric string in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_194__Negative__Invalid_premisesCode_Length("Verify that if the premisesCode length is larger than 7 numeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_195__Negative__Invalid_premisesCode_Format__Not_String("Verify that if the premisesCode value is not a numeric string in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_196__Negative__Invalid_Last_or_Business_Name_Length("Verify that if the customerLastNameBusiness length is larger than 60 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10119, ErrorMessage = 'Invalid Last or Business Name Format'"),
        TC_197__Negative__Invalid_First_Name_Length("Verify that if the customerFirstName length is larger than 15 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10121, ErrorMessage = 'Invalid First Name Format'"),
        TC_198__Negative__Invalid_Last_Four_SSN_Length_Too_Long("Verify that if the lastFourSocialSecurityNumber length is larger than 4 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10063, ErrorMessage = 'Invalid Last Four SSN Format'"),
        TC_199__Negative__Invalid_Last_Four_SSN_Length_Too_Short("Verify that if the lastFourSocialSecurityNumber length is smaller than 4 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10063, ErrorMessage = 'Invalid Last Four SSN Format'"),
        TC_200__Negative__Invalid_Federal_Tax_ID_Length_Too_Long("Verify that if the federalTaxID length is larger than 9 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10069, ErrorMessage = 'Invalid Federal Tax ID Format'"),
        TC_201__Negative__Invalid_Federal_Tax_ID_Length_Too_Short("Verify that if the federalTaxID length is smaller than 9 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10069, ErrorMessage = 'Invalid Federal Tax ID Format'"),
        TC_202__Negative__Invalid_Email_Address_Format("Verify that if the emailAddress format is not {identifier}@{domain name}.{domain extension} in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10065, ErrorMessage = 'Invalid Email Address Format'"),
        TC_203__Negative__Invalid_Phone_Number_Length_Too_Long("Verify that if the phoneNumber length is larger than 10 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10009, ErrorMessage = 'Invalid Phone Number Format'"),
        TC_204__Negative__Invalid_Phone_Number_Length_Too_Short("Verify that if the phoneNumber length is smaller than 10 characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10009, ErrorMessage = 'Invalid Phone Number Format'"),
        TC_205__Negative__Invalid_Username_Format("Verify that if username contains non-alphanumeric characters in the SearchAccounts endpoint request, the endpoint response will return data = null, success = false, ErrorCode = 10353, ErrorMessage = 'Invalid Username Format'"),
        TC_206__Negative__Inactive_Username("Verify that in the SearchAccounts request if the provided username does exist in MariaDb and is Inactive, the endpoint response will return data = null, success = false, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        ...
        TC_256__Positive__MultiFamily("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations for a Multi-Family Account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the customerType parameter in the response is set to 'MF'"),
        TC_257__Positive__Seasonal("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations for a Seasonal Account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the customerType parameter in the response is set to 'SE'"),
        TC_258__Positive__SeniorCitizen("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations for a Senior Citizen Account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the customerType parameter in the response is set to 'SR'"),
        TC_259__Positive__PremisesAddress_StreetNumber("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations where the Street Number is set for the account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the premisesStreetNumber parameter in the response is set to the expected value"),
        TC_260__Positive__PremisesAddress_No_StreetNumber("Verify that if the SearchAccounts endpoint request contains the minimum required fields for a valid search using one of the available combinations where the Street Number is NOT set for the account, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' along with the expected response payload with the results and the premisesStreetNumber parameter in the response is set to an empty string");
