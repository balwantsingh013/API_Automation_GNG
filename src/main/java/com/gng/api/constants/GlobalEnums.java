...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_25__Positive__Usage_History_Read_Type_Format__Actual("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history where at least one service period has an 'Actual' meter reading and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains a readTypeCode that equals 'A' corresponding to the 'Actual' meter reading in Banner"),
        TC_26__Positive__Usage_History_Read_Type_Format__Zero_Consumption("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history where at least one service period has a 'Zero Consumption' meter reading and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains a readTypeCode that equals 'Z' corresponding to the 'Zero Consumption' meter reading in Banner"),
        TC_27__Positive__Usage_History_Read_Type_Format__Estimated("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history where at least one service period has an 'Estimated' meter reading and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains a readTypeCode that equals 'E' corresponding to the 'Estimated' meter reading in Banner"),
        TC_28__Positive__Usage_History_Read_Date_Format("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains a readDate in the expected String(8) formatted as YYYYMMDD"),
        TC_29__Positive__Usage_History_Average_Temperature_Format("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains an averageTemperature in the expected Number format"),
        ...
        TC_31__Positive__Usage_History_Bill_History_Transaction_Format("Verify that if the customerCode and premisesCode for a Banner account not in a 'New' status with at least 1 month of usage history and all other required parameters (requestID, numberOfMonths) are well formed and provided in the GetUsageHistory endpoint request, the endpoint response will return success = true, ErrorCode = 0, ErrorMessage = '' and the usageHistory array contains a billHistoryTransactionNumber in the expected Number(15) format"),
