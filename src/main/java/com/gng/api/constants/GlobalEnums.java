...
public class GlobalEnums {
    ...
    public enum ScenarioDescriptions {
        ...
        TC_12__Positive__Username_Inactive("Verify that in the ValidateUsername endpoint request if the provided username does exist in MariaDb users table with deleted = 1 and domain_id = 2, the endpoint response will return success = true, ErrorCode = 0, and usernameStatus = 'INACTIVE'"),

        TC_13__Negative__Missing_Request_ID("Verify that if the 'requestID' parameter is missing in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_14__Negative__Invalid_Request_ID__Length("Verify that if the provided 'requestID' parameter length is larger than 32 characters in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_15__Negative__Duplicate_Request_ID("Verify that if the provided 'requestID' parameter already exists within Transaction Manager while executing the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_16__Negative__Missing_Username("Verify that if the 'username' parameter is missing in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10349, ErrorMessage = 'Missing Username'"),
        TC_17__Negative__Invalid_Username_format__Length___Too_Short____("Verify that if the provided 'username' parameter length is smaller than 5 characters in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10351, ErrorMessage = 'Invalid Username Length'"),
        TC_18__Negative__Invalid_Username_format__Length___Too_Long____("Verify that if the provided 'username' parameter length is larger than 15 characters in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10351, ErrorMessage = 'Invalid Username Length'"),
        TC_19__Negative__Invalid_Username_format__Alphanumeric("Verify that if the provided 'username' parameter is not alphanumeric in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10353, ErrorMessage = 'Invalid Username Format'"),
        TC_20__Negative__Invalid_Username__Not_Found("Verify that if the provided 'username' parameter is otherwise well formed and used in the UpdatePassword endpoint request but 'username' does not exist in MariaDb 'users' table where domain_id = 2, the endpoint response will return success = false, ErrorCode = 10357, ErrorMessage = 'Username Not Found'"),
        TC_21__Negative__Invalid_Username__Inactive("Verify that if the provided 'username' parameter value exists in MariaDb 'users' table with active value of 0 and domain_id = 2 and is used in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        TC_22__Negative__Invalid_Username__Inactive("Verify that if the provided 'username' parameter value exists in MariaDb 'users' table with deleted value of 1 and domain_id = 2 and is used in the UpdatePassword endpoint request, the endpoint response will return success = false, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        ...
        TC_28__Negative__Missing_Request_ID("Verify that if the 'requestID' parameter is missing in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_29__Negative__Invalid_Request_ID__Length("Verify that if the provided 'requestID' parameter length is larger than 32 characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_30__Negative__Duplicate_Request_ID("Verify that if the provided 'requestID' parameter already exists within Transaction Manager while executing the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_31__Negative__Missing_Username("Verify that if the 'username' parameter is missing in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10349, ErrorMessage = 'Missing Username'"),
        TC_32__Negative__Invalid_Username__Inactive("Verify that if the provided 'username' parameter value does exist in MariaDb 'users' table with active value of 0 and domain_id = 2 and is used in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),

        TC_33__Negative__Invalid_Username__Inactive("Verify that if the provided 'username' parameter value does exist in MariaDb 'users' table with deleted value of 1 and domain_id = 2 and is used in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10355, ErrorMessage = 'Inactive Username'"),
        TC_34__Negative__Invalid_Username_format__Length___Too_Short____("Verify that if the provided 'username' parameter length is smaller than 5 characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10351, ErrorMessage = 'Invalid Username Length'"),
        TC_35__Negative__Invalid_Username_format__Length___Too_Long____("Verify that if the provided 'username' parameter length is larger than 15 characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10351, ErrorMessage = 'Invalid Username Length'"),
        TC_36__Negative__Invalid_Username_format__Alphanumeric("Verify that if the provided 'username' parameter is not alphanumeric in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10353, ErrorMessage = 'Invalid Username Format'"),
        TC_37__Negative__Missing_Password("Verify that if the provided 'password' parameter value is missing in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10113, ErrorMessage = 'Missing Password'"),

        TC_38__Negative__Invalid_Password_Format__Length___Too_Short____("Verify that if the provided 'password' parameter value length is shorter than 8 characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10157, ErrorMessage = 'Invalid Password Format'"),
        TC_39__Negative__Invalid_Password_Format__Length___Too_Long____("Verify that if the provided 'password' parameter value length is longer than 64 characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10157, ErrorMessage = 'Invalid Password Format'"),
        TC_42__Negative__Account_Already_Linked("Verify that if the provided 'customerCode', 'premisesCode' and 'username' in the UpdateUsername endpoint request and the account is already linked to a username, the endpoint response will return success = false, action = null, ErrorCode = 10361, ErrorMessage = 'The account is already linked to a username'"),

        TC_43__Negative__Invalid_credentials___Password____("Verify that if the provided 'password' and 'username' are in the UpdateUsername endpoint request and the password does not match what is in the database where username exists with domain_id 2, the endpoint response will return success = false, action = null, ErrorCode = 10363, ErrorMessage = 'Invalid Credentials'"),
        ...
        TC_46__Negative__Invalid_credentials___Username_Inactive____("Verify that if the provided 'password' and 'username' are in the UpdateUsername endpoint request and username does exist in MariaDb 'users' table with deleted value of 1 and domain_id = 2, the endpoint response will return success = false, action = null, ErrorCode = 10363, ErrorMessage = 'Invalid Credentials'"),
        TC_47__Negative__Missing_customerCode("Verify that if the 'customerCode' value is missing in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10011, ErrorMessage = 'Missing Customer Code'"),

        TC_48__Negative__Invalid_CustomerCode_Format__Too_Long("Verify that if the 'customerCode' length is larger than 9 numeric characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_49__Negative__Invalid_CustomerCode_Format__Not_String("Verify that if the 'customerCode' value is not a string in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_50__Negative__Invalid_CustomerCode__Not_Found("Verify that if the provided combination of 'customerCode' and 'premisesCode' in the UpdateUsername endpoint request doesn't exist in the UCBCUST table in Banner, the endpoint response will return success = false, action = null, ErrorCode = 40015, ErrorMessage = 'Invalid Account Number'"),
        TC_51__Negative__Missing_PremisesCode("Verify that if the 'premisesCode' value is missing in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10013, ErrorMessage = 'Missing Premises Code'"),
        TC_52__Negative__Invalid_PremisesCode_Format__Too_Long("Verify that if the 'premisesCode' length is larger than 7 numeric characters in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),

        TC_53__Negative__Invalid_premisesCode_Format("Verify that if the 'premisesCode' value is not a string in the UpdateUsername endpoint request, the endpoint response will return success = false, action = null, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_54__Positive__Username_Available___Banner_Active____("Verify that if all required fields are set in the UpdateUsername endpoint request and the username is AVAILABLE in MariaDb using an Account Number ('customer code' + 'premises code') for a Banner account in an 'Active' status, the endpoint response will return success = true, ErrorCode = 0, action = 'CREATED' and a new username is created and associated to the Banner account"),
        TC_55__Positive__Username_Available___Banner_New____("Verify that if all required fields are set in the UpdateUsername endpoint request and the username is AVAILABLE in MariaDb using an Account Number ('customer code' + 'premises code') for a Banner account in a 'New' status, the endpoint response will return success = true, ErrorCode = 0, action = 'CREATED' and a new username is created and associated to the Banner account"),
        ...
        TC_57__Positive__Username_Active___Banner_Active____("Verify that if all required fields are set in the UpdateUsername endpoint request and the username is ACTIVE in MariaDb using an Account Number ('customer code' + 'premises code') for a Banner account in an 'Active' status, the endpoint response will return success = true, ErrorCode = 0, action = 'UPDATED' and the existing username is associated to the Banner account"),
        TC_58__Positive__Username_Active___Banner_Final____("Verify that if all required fields are set in the UpdateUsername endpoint request and the username is ACTIVE in MariaDb using an Account Number ('customer code' + 'premises code') for a Banner account in an 'Final' status, the endpoint response will return success = true, ErrorCode = 0, action = 'UPDATED' and the existing username is associated to the Banner account"),
        TC_59__Positive__Username_Active___Banner_Inactive____("Verify that if all required fields are set in the UpdateUsername endpoint request and the username is ACTIVE in MariaDb using an Account Number ('customer code' + 'premises code') for a Banner account in an 'Inactive' status, the endpoint response will return success = true, ErrorCode = 0, action = 'UPDATED' and the existing username is associated to the Banner account"),

        TC_60__Negative__Missing_Request_ID("Verify that if the requestID parameter is missing in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10001, ErrorMessage = 'Missing Request ID'"),
        TC_61__Negative__Invalid_Request_ID__Length("Verify that if the provided requestID parameter length is larger than 32 characters in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10002, ErrorMessage = 'Invalid Request ID'"),
        TC_62__Negative__Duplicate_Request_ID("Verify that if the provided requestID parameter already exists within Transaction Manager while executing the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10003, ErrorMessage = 'Duplicate Request ID'"),
        TC_63__Negative__Missing_CustomerCode("Verify that if the customerCode value is missing in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10011, ErrorMessage = 'Missing Customer Code'"),
        TC_64__Negative__Invalid_CustomerCode_Length("Verify that if the customerCode length is larger than 9 numeric characters in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_65__Negative__Invalid_CustomerCode_Format__Not_String("Verify that if the customerCode value is not a string in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10015, ErrorMessage = 'Invalid Customer Code Format'"),
        TC_66__Negative__Invalid_CustomerCode__Not_Found("Verify that if the provided combination of customerCode and premisesCode in the UpdateAccountNickname endpoint request doesn't exist in the UCBCUST table in Banner, the endpoint response will return success = false, ErrorCode = 40015, ErrorMessage = 'Invalid Account Number'"),
        TC_67__Negative__Missing_PremisesCode("Verify that if the premisesCode value is missing in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10013, ErrorMessage = 'Missing Premises Code'"),
        TC_68__Negative__Invalid_PremisesCode_Length("Verify that if the premisesCode length is larger than 7 numeric characters in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_69__Negative__Invalid_PremisesCode_Format__Not_String("Verify that if the premisesCode value is not a string in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 10005, ErrorMessage = 'Invalid Premises Code Format'"),
        TC_70__Negative__Nickname_Not_Allowed_For_New_Account("Verify that if the customerCode and premisesCode for a Banner account in a New status and a nickname parameter is provided in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 40215, ErrorMessage = 'Nickname not allowed for new account'"),
        TC_71__Negative__Nickname_Already_Exists("Verify that if the customerCode and premisesCode for a Banner account not in a New status where a nickname is already set for the Banner account and a nickname parameter is provided in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 40217, ErrorMessage = 'Nickname already exists for the account'"),
        TC_72__Negative__Nickname_Missing("Verify that if the customerCode and premisesCode for a Banner account not in a New status where a nickname is not set for the Banner account and a nickname parameter is not provided in the UpdateAccountNickname endpoint request, the endpoint response will return success = false, ErrorCode = 40219, ErrorMessage = 'Nickname does not exist in the request'"),
        TC_73__Positive__Nickname_Set__Active("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Active status where an existing nickname is not set, the endpoint response will return success = true, ErrorCode = 0 and the provided nickname is associated to the Banner account"),
        TC_74__Positive__Nickname_Set__Final("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in a Final status where an existing nickname is not set, the endpoint response will return success = true, ErrorCode = 0 and the provided nickname is associated to the Banner account"),
        TC_75__Positive__Nickname_Set__Inactive("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Inactive status where an existing nickname is not set, the endpoint response will return success = true, ErrorCode = 0 and the provided nickname is associated to the Banner account"),
        TC_76__Positive__Nickname_Updated__Active("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Active status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and a new nickname is associated to the Banner account"),
        TC_77__Positive__Nickname_Updated__Final("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in a Final status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and a new nickname is associated to the Banner account"),
        TC_78__Positive__Nickname_Updated__Inactive("Verify that if all required fields are set and a value for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Inactive status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and a new nickname is associated to the Banner account"),
        TC_79__Positive__Nickname_Removed__Active("Verify that if all required fields are set and an EMPTY value ('') for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Active status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and the nickname associated to the Banner account is set to EMPTY ('')"),
        TC_80__Positive__Nickname_Removed__Final("Verify that if all required fields are set and an EMPTY value ('') for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in a Final status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and the nickname associated to the Banner account is set to EMPTY ('')"),
        TC_81__Positive__Nickname_Removed__Inactive("Verify that if all required fields are set and an EMPTY value ('') for the nickname parameter is provided in the UpdateAccountNickname endpoint request for a Banner account in an Inactive status where an existing nickname is set, the endpoint response will return success = true, ErrorCode = 0 and the nickname associated to the Banner account is set to EMPTY ('')"),
        TC_82__Positive__LoginID_Saved("Verify that if a value is provided for the optional loginID parameter in the UpdateAccountNickname endpoint request and the rest of the request is well formed, the endpoint response will return success = true, ErrorCode = 0, and the loginID value is saved in the GZRAPIL_LOGIN_ID field in the GZRAPIL table"),
