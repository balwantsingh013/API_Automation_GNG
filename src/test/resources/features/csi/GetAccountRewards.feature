Feature: Verify GetAccountRewards Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_132__Negative__Invalid_Account_Number     | 40015     | Invalid Account Number       |
      | TC_133__Negative__Missing_premisesCode       | 10013     | Missing Premises Code        |
  ...
  @GetAccountRewardsPositive12 @HappyFlow @CSI
  Scenario Outline: "<testCondition>"
    When a request is made to GetAccountRewards Api for "<testCondition>"
    Then verify response code of "GetAccountRewards" Api is 200
    And response should have ErrorCode <errorCode> and ErrorMessage "<errorMessage>"
    ...
    Examples:
      | testCondition                                               | errorCode | errorMessage |
#      | TC_136__Positive__Rewards_Response_Returned_with_Active_Rewards                            | 0         |              |
      | TC_137__Positive__Rewards_Response_Returned_with_Pending_Rewards                         | 0         |              |
#      | TC_138__Positive__Rewards_Response_Returned_with_Active_and_Pending_Rewards               | 0         |              |
#      | TC_139__Positive__Rewards_Response_Returned_with_No_Rewards                               | 0         |              |
#      | TC_140__Positive__Active_Rewards_Response_Returned_with_RewardsRefer_A_Friend_Rewards                    | 0         |              |
#      | TC_141__Positive__Pending_Rewards_Response_Returned_with_RewardsRefer_A_Friend_Rewards                    | 0         |              |
