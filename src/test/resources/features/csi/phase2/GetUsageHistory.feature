Feature: Verify GetUsageHistory Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_12__Negative__Invalid_Number_of_Months__Format__Not_a_Number | 10000 | The JSON value could not be converted to System.Nullable`1[System.Int32]. Path: $.numberOfMonths [PIPE] LineNumber: 0 [PIPE]|
      ...
      | TC_15__Negative__Invalid_Number_of_Months__Length            | 10405     | Number of Months exceeds maximum allowed            |
