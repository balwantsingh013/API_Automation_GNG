Feature: Verify GetUsageHistory Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_16__Negative__New_Account_Not_Allowed                     | 40271     | Operation Not Allowed for New Account |
...
#    And the response should have data as "<data>"
    ...
    Examples:
      ...
      | TC_17__Positive__Usage_History_Service_Number_Format            | 0         |              | notNull |
      | TC_18__Positive__Usage_History_Bill_Date_Format                | 0         |              | notNull |
      | TC_19__Positive__Usage_History_Usage_From_Date_Format          | 0         |              | notNull |
      | TC_20__Positive__Usage_History_Usage_To_Date_Format            | 0         |              | notNull |
      | TC_21__Positive__Usage_History_Average_Daily_Actual_Consumption_Format | 0 |          | notNull |
      | TC_22__Positive__Usage_History_Average_Daily_Billed_Consumption_Format | 0 |          | notNull |
      | TC_23__Positive__Usage_History_Total_Billed_Consumption_Format | 0         |              | notNull |
      | TC_24__Positive__Usage_History_Days_Of_Service_Format          | 0         |              | notNull |
      | TC_25__Positive__Usage_History_Reading_Format                  | 0         |              | notNull |
      | TC_26__Positive__Usage_History_Read_Type_Format__Actual        | 0         |              | notNull |
      | TC_27__Positive__Usage_History_Read_Type_Format__Zero_Consumption | 0      |              | notNull |
      | TC_28__Positive__Usage_History_Read_Type_Format__Estimated     | 0         |              | notNull |
      | TC_29__Positive__Usage_History_Read_Date_Format                | 0         |              | notNull |
      | TC_30__Positive__Usage_History_Average_Temperature_Format      | 0         |              | notNull |
      | TC_31__Positive__Usage_History_Heating_Degree_Days_Format      | 0         |              | notNull |
      | TC_32__Positive__Usage_History_Bill_History_Transaction_Format | 0         |              | notNull |
