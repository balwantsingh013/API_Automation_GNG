Feature: Verify GetPaymentHistory Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_135__Negative__Invalid_Account_Number_           | 40015     | Invalid Account Number                      |
      | TC_136__Negative__Missing_Number_of_Months         | 10393     | Missing Number of Months                    |
      | TC_137__Negative__Invalid_Number_of_Months_Format__Not_a_Number | 10000 | The JSON value could not be converted to System.Nullable`1[System.Int32]. Path: $.numberOfMonths [PIPE] LineNumber: 0 [PIPE]|
