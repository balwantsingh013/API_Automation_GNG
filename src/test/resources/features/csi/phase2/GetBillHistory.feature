Feature: Verify GetBillHistory Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_71__Negative__Invalid_Number_of_Months_Format_NotANumber | 10000 | The JSON value could not be converted to System.Nullable`1[System.Int32]. Path: $.numberOfMonths [PIPE] LineNumber: 0 [PIPE]|
