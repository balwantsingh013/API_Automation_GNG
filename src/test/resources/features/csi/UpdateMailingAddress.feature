Feature: Verify UpdateMailingAddress Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_92__Negative__Invalid_Street_Number_Length      | 10129     | Invalid Street Number Format       |
      | TC_93__Negative__Invalid_Street_Pre_Direction_Length | 10131   | Invalid Street Pre-Direction Format|
      ...
      | TC_97__Negative__Invalid_StreetSuffix_Length       | 10135     | Invalid Street Suffix Format       |
      | TC_98__Negative__Invalid_StreetSuffix              | 40221     | Invalid Street Suffix              |
      | TC_99__Negative__Invalid_Street_Post_Direction_Length | 10137   | Invalid Street Post-Direction Format|
      | TC_100__Negative__Invalid_Street_Post_Direction     | 40229     | Invalid Street Post-Direction      |
      | TC_101__Negative__Invalid_Unit_Type_Format          | 10139     | Invalid Unit Type Format           |
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      | testCondition                           | errorCode | errorMessage |
      | TC_125__Positive__LoginID_Saved         | 0         |              |
