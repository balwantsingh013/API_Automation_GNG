Feature: Verify UpdateMailingAddress Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      ...
      | TC_75__Negative__Missing_premisesCode                       | 10013     | Missing Premisses Code             |
      ...
      | TC_90__Negative__Invalid_Unit_Type__Format                  | 10135     | Invalid Unit Type Format           |
      | TC_91__Negative__Missing_Unit_Type                          | 40223     | Invalid Street Unit Type           |
      | TC_92__Negative__Invalid_Unit_Number__Format                | 10135     | Invalid Unit Number Format         |
      | TC_93__Negative__Invalid_City__Length                       | 10135     | Invalid Unit Type Format           |
      ...
      | TC_103__Negative__Invalid_Additional_Address_Line__Length   | 10373     | Invalid Attention To Format        |
