...
#
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      | testCondition                                                                                   | errorCode | errorMessage |
#      | TC_291__Positive__Last_4_SSN_And_Customer_Last_Name_Username_Present                            | 0         |              |
#      | TC_292__Positive__Last_4_SSN_And_Email_Address_Username_Present                                 | 0         |              |
#      | TC_293__Positive__Last_4_SSN_And_Phone_Number_Username_Present                                  | 0         |              |
#      | TC_294__Positive__Password_And_Customer_Last_Name_Username_Present                               | 0         |              |
#      | TC_295__Positive__Mixed_Username_Population_in_Multi_Result_Response                             | 0         |              |
#      | TC_296__Positive__No_Username_Exact_Empty_String_Contract_Validation                             | 0         |              |
#      | TC_297__Positive__Username_Consistency_Across_Search_Paths                                       | 0         |              |
#
#  @SearchAccounts987 @NegativeFlow @CSI @searchAccountsCSI
#  Scenario Outline: "<testCondition2>"
#    When a request is made to SearchAccounts Api for "<testCondition>"
#    Then verify response code of "SearchAccounts" Api is 200
#    And response should have ErrorCode <errorCode> and ErrorMessage "<errorMessage>"
#    When a request is made to SearchAccounts Api for "<testCondition2>"
#    And response should have ErrorCode <errorCode> and ErrorMessage "<errorMessage>"
#
#    Examples:
#      | testCondition                                                                                   | errorCode | errorMessage |testCondition2|
#      | TC_294__Positive__Password_And_Customer_Last_Name_Username_Present                               | 0         |              |TC_297__Positive__Username_Consistency_Across_Search_Paths|
#
#  @SearchAccounts987 @NegativeFlow @CSI @searchAccountsCSI
#  Scenario Outline: "<testCondition>"
#    When a request is made to SearchAccounts Api for "<testCondition>"
...
#    Examples:
#      | testCondition                                                                                   | errorCode | errorMessage |
#      | TC_298__Positive__Username_Record_to_Record_Mapping_Validation                                   | 0         |              |
