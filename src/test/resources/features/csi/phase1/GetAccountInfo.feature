Feature: Verify GetAccountInfo Api
  ...
  Scenario Outline: "<testCondition>"
    ...
    Examples:
      | testCondition                                                                                     | errorCode | errorMessage | success |
      | TC_1__Positive__Account_Info_Returned___Renewal_Indicator_Format____                              | 0         |              | true    |
      | TC_2__Positive__Account_Info_Returned___Renewal_Indicator_equals_Y____                            | 0         |              | true    |
      | TC_3__Positive__Account_Info_Returned___Renewal_Indicator_equals_N____                            | 0         |              | true    |
      | TC_4__Positive__Account_Info_Returned___Renewal_Indicator_equals_Dash____                         | 0         |              | true    |
      | TC_5__Positive__Account_Info_Returned___Guaranteed_Plan_Pricing_Model____                         | 0         |              | true    |
