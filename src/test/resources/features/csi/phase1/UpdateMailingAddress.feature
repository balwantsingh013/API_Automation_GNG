...
#      | TC_128__Positive__LoginID_Saved         | 0         |              |
  ...
  @UpdateMailingAddressPositive @UpdateMailingAddressPendingEnrollmentNewAccount @HappyFlow @CSI
  Scenario Outline: "<testCondition>"
    When a request is made to UpdateMailingAddress Api for "<testCondition>"
    Then verify response code of "UpdateMailingAddress" Api is 200
    And response should have ErrorCode <errorCode> and ErrorMessage "<errorMessage>"
    ...
    Examples:
      | testCondition                                                                 | errorCode | errorMessage |
      | TC_9__Positive__Valid_Street_Address___Minimum_Parameters_NEW_Account____   | 0         |              |
      | TC_10__Positive__Valid_Street_Address___Maximum_Parameters_NEW_Account____  | 0         |              |
      | TC_11__Positive__Valid_PO_Box_Address___NEW_Account____                      | 0         |              |
      | TC_12__Positive__Valid_Rural_Route_Address___NEW_Account____                 | 0         |              |
