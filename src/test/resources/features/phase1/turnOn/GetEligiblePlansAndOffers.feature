...
#    |COMMERCIAL_CREDIT_CHECK_YES_NEW_ENROLLMENT_TC_347          |
  ...
  Scenario Outline: GetEligiblePlansAndOffersApi- Verify response code for invalid "<testCondition>"
    ...
    Examples:
      ...
      | GET_ELIGIBLE_PLANS_AND_OFFERS_FROZEN_ACCOUNT_357           | 11113     | Credit file blocked by consumer.  Inform customer to contact Experian regarding the credit block at 888-397-3742.  DO NOT override denial.                                                          |
