Feature: Verify GetEligiblePlansAndOffers Api
  ...
  #|COMMERCIAL_CREDIT_CHECK_YES_NEW_ENROLLMENT_TC_342|  > bug: Experian System Error
  ...
  #|COMMERCIAL_CREDIT_CHECK_YES_NEW_ENROLLMENT_TC_347| found data but some mismatch
    ...
    #|COMMERCIAL_CREDIT_CHECK_YES_INCL_ENROLLMENT_TC_350| new bug and federal tax id not found for this TC
    |COMMERCIAL_CREDIT_CHECK_YES_CRDS_ENROLLMENT_TC_350B        |
    #|COMMERCIAL_CREDIT_CHECK_YES_CRDS_ENROLLMENT_TC_350E|  >  bug: Experian System Error
