Feature: Verify GetDefaultPlansAndOffers Api
  ...
  @GetDefaultPlansAndOffersPositive @HappyFlow @Phase1 @turnOn
  ...
  @GetDefaultPlansAndOffersNegativeInvalidRequestId @Phase1 @NegativeFlow @turnOn
  ...
  @GetDefaultPlansAndOffersNegativeInvalidLoginId @Phase1 @NegativeFlow @turnOn
  ...
  @GetDefaultPlansAndOffersNegativeInvalidCustomerType @Phase1 @NegativeFlow @turnOn
  ...
  @GetDefaultPlansAndOffersNegativeInvalidTransactionType @Phase1 @NegativeFlow @turnOn
  ...
  @GetDefaultPlansAndOffersNegativeInvalidEnrollmentSource @Phase1 @NegativeFlow @turnOn
  ...
  @InvalidMarketingPromotionCodes @Phase1 @NegativeFlow @turnOn
  Scenario Outline: GetDefaultPlansAndOffers Api - Verify GetDefaultPlansAndOffers Api with invalid enrollmentSource for "<testCondition>" condition
