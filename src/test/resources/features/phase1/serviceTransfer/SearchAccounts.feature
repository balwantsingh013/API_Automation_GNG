Feature: Verify SearchAccounts ServiceTransfer Api
  ...
  Scenario Outline: SearchAccountsApiServiceTransfer Api - Verify the results for <testCondition>
    ...
    Examples:
      ...
      |INACTIVE_UNAPPLIED_DEPOSIT_TC_51       |0        |            |1          |I            |false        |25              |0            |0            |0000              |
      |INACTIVE_PAST_DUE_TC_52                |0        |            |1          |I            |false        |0               |199.37       |0            |0000              |
      ...
      |NEW_UNAPPLIED_DEPOSIT_TC_57            |0        |            |1          |N            |false        |25              |0            |0            |0000              |
      |RS_NEW_BANKRUPCY_TC_58                 |0        |            |1          |N            |false        |0               |0            |0            |BANK              |
      |FINAL_UNAPPLIED_DEPOSIT_TC_60          |0        |            |1          |F            |false        |250             |0            |0            |0000              |
      |ACTIVE_PAST_DUE_TC_61                  |0        |            |1          |A            |false        |0               |81.28        |0            |0000              |
      |ACTIVE_SONP_PAST_DUE_TC_68             |0        |            |1          |A            |true         |0               |336.98       |0            |0000              |
  ...
  Scenario Outline: SearchAccountsApiServiceTransfer Api - Verify the no results are returned for <testCondition>
    ...
    Examples:
      ...
      |ACTIVE_UNAPPLIED_DEPOSIT_TC_64         |0        |            |1          |A            |false        |0               |0            |RGB                   |Residential Guaranteed Bill           |No Restrictions                                                  |
  ...
  Scenario Outline: SearchAccountsApiServiceTransfer Api - Verify the no results are returned for <testCondition>
    ...
    Examples:
      ...
      |ACTIVE_GREENER_LIFE_SONP_TC_69         |0        |            |1          |A            |true         |0               |48.97        |0            |0000              |true       |
      |ACTIVE_GREENER_LIFE_NO_SONP_TC_62      |0        |            |1          |A            |false        |0               |0            |0            |0000              |true       |
