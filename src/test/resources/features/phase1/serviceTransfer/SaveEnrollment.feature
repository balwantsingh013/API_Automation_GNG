Feature: Verify ServiceTransfer SaveEnrollment Api
  ...
  @ServiceTransferSaveEnrollmentNegative @NegativeFlow @Phase2 @serviceTransfer
  ...
  @ServiceTransferSaveEnrollmentWithEligibleNegative @NegativeFlow @Phase2 @serviceTransfer
  Scenario Outline: Verify ServiceTransfer SaveEnrollment error with eligible flow for "<testCondition>"
    ...
    Examples:
      ...
      | ST_SE_CURRENT_PRICE_PLAN_FIXED_BOOLEAN_ONLY_TC248               | 10000     | The JSON value could not be converted to System.Nullable`1[System.Boolean]. Path: $.serviceTransferCurrentPricePlan \| LineNumber: 0 \| BytePositionInLine: 553. |
      | ST_SE_CURRENT_PRICE_PLAN_CEILING_BOOLEAN_ONLY_TC249             | 10000     | The JSON value could not be converted to System.Nullable`1[System.Boolean]. Path: $.serviceTransferCurrentPricePlan \| LineNumber: 0 \| BytePositionInLine: 559. |
