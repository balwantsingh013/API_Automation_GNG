Feature: Get Reasons For Leaving Api
  ...
  @GetReasonsForLeavingNegative @Phase1 @NegativeFlow @GetReasonsForLeavingTOFF
  ...
  @GetReasonsForLeavingNegative1 @Phase1 @NegativeFlow @GetReasonsForLeavingTOFF
  Scenario Outline: GetReasonsForLeavingApiTOFF- Verify Response when a Get reasons for leaving request is send with invalid parameters <testCondition>
  ...
  @GetReasonsForLeavingNegative2 @Phase1 @NegativeFlow @GetReasonsForLeavingTOFF
