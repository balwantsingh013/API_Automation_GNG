...
public class CreateAccountNoteApiPage extends BasePage {
    ...
    public void sendCreateAccountNoteRequestWithInvalidParameters(DataTable dataTable) {
    ...
    public void verifyValidNoteSequenceNumber() {
        assertThat("noteSequenceNumber is Null", testContext.getCreateAccountNoteResponse().getData().getNoteSequenceNumber(), notNullValue());
    }
