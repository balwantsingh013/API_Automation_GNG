...
public class SearchAccountsApiPage extends BasePage {
    ...
    private final com.gng.api.pages.meterSet.AccountsApiPages.SearchAccounts.SearchAccountsHelper helper;

    public SearchAccountsApiPage(TestContext testContext) {
        super(testContext);
        this.helper = new com.gng.api.pages.meterSet.AccountsApiPages.SearchAccounts.SearchAccountsHelper(testContext);
    }
