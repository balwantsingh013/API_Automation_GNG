...
public class GetAccountInfoApiHelper {
    ...
    public void preparePayloadForTestCondition(GetAccountInfoRequest payload, GetAccountInfoLabel testCondition) {
        ...
        switch (testCondition) {
            case TC_141__Negative__Missing_Request_ID:
                payload.setRequestID("");
                break;

            case TC_142__Negative__Invalid_Request_ID__Length:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(33));
                break;

            case TC_143__Negative__Duplicate_Request_ID:
                payload.setRequestID(GlobalEnums.InvalidValues.DUPLICATE_REQUEST_ID.getValue());
                break;

            case TC_144__Negative__Invalid_customerCode_Length:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(FakerDataGenerator.generateDigits(10)); // >9 digits
                break;

            case TC_145__Negative__Invalid_customerCode_Format:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(FakerDataGenerator.generateAlphanumeric(6)); // not purely numeric
                break;

            case TC_146__Negative__Invalid_premisesCode_Length:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setPremisesCode(FakerDataGenerator.generateDigits(8)); // >7 digits
                break;

            case TC_147__Negative__Invalid_premisesCode_Format:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setPremisesCode(FakerDataGenerator.generateAlphanumeric(6)); // not purely numeric
                break;

            case TC_148__Negative__Invalid_Account_Number:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode("9999999");
                break;

            case TC_149__Positive__Account_Info_Returned___Email_Address____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_150__Positive__Account_Info_Returned___No_Email_Address____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_151__Positive__Account_Info_Returned___Partner_Promotions_Indicator__equals_Y____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_152__Positive__Account_Info_Returned___Partner_Promotions_Indicator__equals_N____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_153__Positive__Account_Info_Returned___Partner_Promotions_Indicator_is_null____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_154__Positive__Account_Info_Returned___Marketing_Offers_Indicator__equals_Y____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_155__Positive__Account_Info_Returned___Marketing_Offers_Indicator__equals_N____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_156__Positive__Account_Info_Returned___Marketing_Offers_Indicator_is_null____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_157__Positive__Account_Info_Returned___Account__and_Billing_Reminder__equals_Y____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_158__Positive__Account_Info_Returned___Account__and_Billing_Reminder__equals_N____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_159__Positive__Account_Info_Returned___Account__and_Billing_Reminder_is_null____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_160__Positive__Account_Info_Returned___Primary_Phone_is_Home____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_161__Positive__Account_Info_Returned___Primary_Phone_is_Work____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_162__Positive__Account_Info_Returned___Primary_Phone_is_both_Home_and_Work____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_163__Positive__Account_Info_Returned___No_Phone_Number____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_164__Positive__Account_Info_Returned___Greener_Life_Rate____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_165__Positive__Account_Info_Returned___No_Greener_Life_Rate____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_166__Positive__Account_Info_Returned___Bill_Delivery_Option_is_Paper____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_167__Positive__Account_Info_Returned___Bill_Delivery_Option_is_Electronic____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_168__Positive__Account_Info_Returned___Bill_Delivery_Option_is_Fiserv_E__Bill____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_169__Positive__Account_Info_Returned___Bill_Delivery_Option_is_null____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_170__Positive__Account_Info_Returned___Correspondence_Delivery_Option_is_Paper____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_171__Positive__Account_Info_Returned___Correspondence_Delivery_Option_is_Electronic____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_172__Positive__Account_Info_Returned___Correspondence_Delivery_Option_is_null____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_173__Positive__Account_Info_Returned___Single_Price_Plan____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_174__Positive__Account_Info_Returned___Multiple_Price_Plans____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_175__Positive__Account_Info_Returned___No_Guaranteed_Bill_Plan____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_176__Positive__Account_Info_Returned___Guaranteed_Bill_Plan____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_177__Positive__Account_Info_Returned___No_Price_Protection_Guarantee_Plan____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_178__Positive__Account_Info_Returned___Price_Protection_Guarantee_Plan____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_179__Positive__Account_Info_Returned___No_Rollover___ACR__Plans____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_180__Positive__Account_Info_Returned___Rollover___ACR__Plans____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_181__Positive__Account_Info_Returned___Non__Restricted_Plans____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_182__Positive__Account_Info_Returned___Restricted_Plans____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_186__Positive__Account_Info_Returned___Transferrable_Discount____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_187__Positive__Account_Info_Returned___Non__Transferrable_Discount____:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
