...
public class UpdateAccountNicknameApiHelper {
    ...
    public void preparePayloadForTestCondition(UpdateAccountNicknameRequest payload, UpdateAccountNicknameLabel testCondition) {
        ...
        switch (testCondition) {
            ...
            case TC_61__Negative__Invalid_Request_ID__Length:
            ...
            case TC_65__Negative__Invalid_CustomerCode_Format__Not_String:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_66__Negative__Invalid_CustomerCode__Not_Found:
            ...
            case TC_67__Negative__Missing_PremisesCode:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_68__Negative__Invalid_PremisesCode_Length:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
            ...
            case TC_69__Negative__Invalid_PremisesCode_Format__Not_String:
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(FakerDataGenerator.generateDigits(9));
            ...
            case TC_70__Negative__Nickname_Not_Allowed_For_New_Account:
            ...
            case TC_71__Negative__Nickname_Already_Exists:
            ...
            case TC_72__Negative__Nickname_Missing:
            ...
            case TC_73__Positive__Nickname_Set__Active:
            ...
            case TC_74__Positive__Nickname_Set__Final:
            ...
            case TC_75__Positive__Nickname_Set__Inactive:
            ...
            case TC_76__Positive__Nickname_Updated__Active:
                accountData = ApplicationContext.get().getDbAction().getAccountWithNickname();
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(accountData.get("UCRACCT_CUST_CODE").toString());
                payload.setPremisesCode(accountData.get("UCRACCT_PREM_CODE").toString());
            ...
            case TC_77__Positive__Nickname_Updated__Final:
            ...
            case TC_78__Positive__Nickname_Updated__Inactive:
            ...
            case TC_79__Positive__Nickname_Removed__Active:
                accountData = ApplicationContext.get().getDbAction().getAccountWithNickname();
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(accountData.get("UCRACCT_CUST_CODE").toString());
                payload.setPremisesCode(accountData.get("UCRACCT_PREM_CODE").toString());
            ...
            case TC_80__Positive__Nickname_Removed__Final:
                accountData = ApplicationContext.get().getDbAction().getFinalAccountWithNickname();
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(accountData.get("UCRACCT_CUST_CODE").toString());
                payload.setPremisesCode(accountData.get("UCRACCT_PREM_CODE").toString());
            ...
            case TC_81__Positive__Nickname_Removed__Inactive:
                accountData = ApplicationContext.get().getDbAction().getInactiveAccountWithNickname();
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(accountData.get("UCRACCT_CUST_CODE").toString());
                payload.setPremisesCode(accountData.get("UCRACCT_PREM_CODE").toString());
            ...
            case TC_82__Positive__LoginID_Saved:
                accountData = ApplicationContext.get().getDbAction().getAccountWithoutNickname();
                payload.setRequestID(FakerDataGenerator.generateAlphanumeric(6));
                payload.setCustomerCode(accountData.get("UCRACCT_CUST_CODE").toString());
                payload.setPremisesCode(accountData.get("UCRACCT_PREM_CODE").toString());
