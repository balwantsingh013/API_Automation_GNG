...
public enum GetUsageHistoryLabel {
    ...
    TC_16__Positive__Usage_History_Service_Number_Format,
    TC_17__Positive__Usage_History_Bill_Date_Format,
    TC_18__Positive__Usage_History_Usage_From_Date_Format,
    TC_19__Positive__Usage_History_Usage_To_Date_Format,
    TC_20__Positive__Usage_History_Average_Daily_Actual_Consumption_Format,
    TC_21__Positive__Usage_History_Average_Daily_Billed_Consumption_Format,
    TC_22__Positive__Usage_History_Total_Billed_Consumption_Format,
    TC_23__Positive__Usage_History_Days_Of_Service_Format,
    TC_24__Positive__Usage_History_Reading_Format,
    TC_25__Positive__Usage_History_Read_Type_Format__Actual,
    TC_26__Positive__Usage_History_Read_Type_Format__Zero_Consumption,
    TC_27__Positive__Usage_History_Read_Type_Format__Estimated,
    TC_28__Positive__Usage_History_Read_Date_Format,
    TC_29__Positive__Usage_History_Average_Temperature_Format,
    TC_30__Positive__Usage_History_Heating_Degree_Days_Format,
    TC_31__Positive__Usage_History_Bill_History_Transaction_Format,
