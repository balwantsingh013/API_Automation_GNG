...
public enum GetAccountRewardsLabel {
    ...
    TC_133__Negative__Missing_premisesCode,
    TC_134__Negative__Invalid_premisesCode_Length,
    TC_135__Negative__Invalid_premisesCode_Format,

    // Positive test conditions
    TC_136__Positive__Rewards_Response_Returned_with_Active_Rewards,
    TC_137__Positive__Rewards_Response_Returned_with_Pending_Rewards,
    TC_138__Positive__Rewards_Response_Returned_with_Active_and_Pending_Rewards,
    TC_139__Positive__Rewards_Response_Returned_with_No_Rewards,
    TC_140__Positive__Active_Rewards_Response_Returned_with_RewardsRefer_A_Friend_Rewards,
