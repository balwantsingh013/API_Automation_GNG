...
public class GetDefaultPlansAndOffersApiSteps {
    ...
    public void PositiveDefaultPlansAndOffersApi(String customerType, String promotionCode, String enrollmentSource, String testCondition) {
        getDefaultPlansAndOffersApiPage.setRequestParams(get_default_plans_and_offers, GlobalEnums.CustomerType.valueOf(customerType), promotionCode, GlobalEnums.EnrollmentSource.valueOf(enrollmentSource), GetDefaultPlansAndOffersApiLabel.valueOf(testCondition)
        );
    }
