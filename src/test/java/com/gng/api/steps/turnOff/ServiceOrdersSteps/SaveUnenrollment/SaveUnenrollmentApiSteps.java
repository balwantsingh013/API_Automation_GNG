...
public class SaveUnenrollmentApiSteps {
    ...
    {
        saveUnenrollmentApiPage.validateForActiveRAMVS(save_unenrollment, pricePlan, sclsCode, forwardingAddressIs, type, SaveUnenrollmentApiLabel.valueOf(testCondition), booleanValue(setEmail), booleanValue(etcExists));
    }
}
