...
public class SaveUnenrollmentApiSteps {
    ...
    {
        saveUnenrollmentApiPage.validateForActiveRAMVS(save_unenrollment, pricePlan, sclsCode, forwardingAddressIs, type, TurnOffReason.fromString(turnoffreason), setEmail, booleanValue(etcExists));
    }
}
